        ...
        <Card.Body>
          <Form>
            <Form.Group>
              ...
              <Form.Control size='sm' type="text" name='name' placeholder="Enter project name" value={state.name} onChange={handleValueChange} />
            </Form.Group>
            <Form.Group>
              <Form.Label>Description</Form.Label>
              <Form.Control size='sm' as="textarea" rows="8" name='description' value={state.description} onChange={handleValueChange} />
            </Form.Group>
          </Form>
        </Card.Body>
        <Card.Footer>
